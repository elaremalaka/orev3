"""RQ-003 Experiment 4: Deployment-per-Miner ordering.

This module implements the governing protocol without Strategy, Deployment,
RFC-010 evaluation, unapproved derived measurements, or RFC-011 economics.
...
EXPERIMENT4_PROTOCOL_SOURCE_REVISION = (
    "3112ab78a64f92892a70d5d4cbd17e1d14b1c2fe"
)
EXPERIMENT4_DATASET_SHA256 = (
    "7680856bc6a01f9b69be0921d6e66b3f43d5241a38e63b37871b6925c1d59ba7"
)
EXPERIMENT4_REQUESTED_SLOTS_REMAINING = 5
EXPERIMENT4_FOLD_COUNT = 5
EXPERIMENT4_ADEQUATE_SUPPORT = 100
EXPERIMENT4_BOOTSTRAP_REPLICATES = 10_000
EXPERIMENT4_BOOTSTRAP_CONFIDENCE = 0.975

OUTCOME_BLIND_PROVENANCE_NAME = PROFILED_PROVENANCE_NAME
AUDIT_MANIFEST_NAME = PROFILED_AUDIT_MANIFEST_NAME
...
_FEATURE_SET_DOMAIN = "rq003-experiment-004-feature-set-v1"
_PRIMARY_RANKING_DOMAIN = "rq003-experiment-004-primary-ranking-v1"
_ASCENDING_RANKING_DOMAIN = "rq003-experiment-004-ascending-sensitivity-v1"
_DETERMINISTIC_BASELINE_DOMAIN = (
    "rq003-experiment-004-deterministic-baseline-v1"
)
_SEEDED_RANDOM_DOMAIN = "rq003-experiment-004-seeded-random-v1"
_RANKING_RECORD_DOMAIN = "rq003-experiment-004-ranking-record-v1"
_EVALUATION_RECORD_DOMAIN = "rq003-experiment-004-evaluation-record-v1"
_REPORT_DOMAIN = "rq003-experiment-004-report-v1"
_BOOTSTRAP_DOMAIN = "rq003-experiment-004-moving-block-bootstrap-v1"
_EXPERIMENT_CONFIGURATION_DOMAIN = "rq003-experiment-004-configuration-v3"
_REPLAY_DATASET_SCHEMA_DOMAIN = "rq003-replay-dataset-schema-v1"
_REPLAY_ROUND_DOMAIN = "rq003-experiment-004-replay-round-v1"
_PROTOCOL_REVISION_POPULATION_DOMAIN = (
    "rq003-experiment-004-protocol-revision-population-v1"
)
_OUTCOME_SOURCE_DOMAIN = "rq003-experiment-004-outcome-source-v1"
_MEASUREMENT_COMPONENT_SET_DOMAIN = (
    "rq003-experiment-004-measurement-component-set-v1"
)
_DERIVED_SEMANTIC_DOMAIN = "rq003-experiment-004-derived-semantic-v1"
_DERIVED_IMPLEMENTATION_DOMAIN = "rq003-experiment-004-derived-implementation-v1"
_DERIVED_DEPENDENCY_DOMAIN = "rq003-experiment-004-derived-dependency-v1"
_DERIVED_ELIGIBILITY_DOMAIN = "rq003-experiment-004-derived-eligibility-v1"
_DERIVED_EXECUTABLE_BINDING_DOMAIN = (
    "rq003-experiment-004-derived-executable-binding-v1"
)
...
EXPERIMENT4_SPECIFICATION_BINDING = ExecutionSpecificationV2Binding(
    EXECUTION_SPECIFICATION_V2_REVISION,
    EXECUTION_SPECIFICATION_V2_SHA256,
)
EXPERIMENT4_PROFILE_BINDING = ExecutionProfileBinding(
    OUTCOME_AWARE_PROFILE,
)

EXPERIMENT4_DATASET_SCHEMA_IDENTITY = execution_identity(
...
EXPERIMENT4_PROTOCOL_REVISION_POPULATION_IDENTITY = execution_identity(
    _PROTOCOL_REVISION_POPULATION_DOMAIN,
    {
        "dataset_sha256": EXPERIMENT4_DATASET_SHA256,
        "official_source_revision": EXPERIMENT4_PROTOCOL_SOURCE_REVISION,
        "scope": "homogeneous_legacy_replay_population",
    },
)

EXPERIMENT4_DERIVED_SEMANTIC_IDENTITY = execution_identity(
    _DERIVED_SEMANTIC_DOMAIN,
    {
        "decision_time_role": "observable_relationship",
...
EXPERIMENT4_DERIVED_DEPENDENCY_IDENTITY = execution_identity(
    _DERIVED_DEPENDENCY_DOMAIN,
    {
        ...
        "same_frozen_execution_context": True,
    },
)
EXPERIMENT4_DERIVED_IMPLEMENTATION_IDENTITY = execution_identity(
    _DERIVED_IMPLEMENTATION_DOMAIN,
    {
        "algorithm": "canonical_reduced_rational_exact_cross_multiplication",
        "definition_identity": DEPLOYMENT_PER_MINER_DEFINITION_IDENTITY,
        "empty_square_extension": {"denominator": 1, "numerator": 0},
        "implementation": "orev3.experiments.rq003_experiment2a.deployment_per_miner",
        "positive_deployment_zero_miners": "invalid",
    },
)
EXPERIMENT4_DERIVED_ELIGIBILITY_IDENTITY = execution_identity(
    _DERIVED_ELIGIBILITY_DOMAIN,
    {
        "decision_time_only": True,
        "definition_identity": DEPLOYMENT_PER_MINER_DEFINITION_IDENTITY,
        "outcome_access": "prohibited_before_ranking_freeze",
        "protocol_source_revision": EXPERIMENT4_PROTOCOL_SOURCE_REVISION,
        "status": "approved_for_experiment_004",
    },
)
EXPERIMENT4_DERIVED_EXECUTABLE_BINDING_IDENTITY = execution_identity(
    _DERIVED_EXECUTABLE_BINDING_DOMAIN,
    {
        "definition_identity": DEPLOYMENT_PER_MINER_DEFINITION_IDENTITY,
        "dependency_identity": EXPERIMENT4_DERIVED_DEPENDENCY_IDENTITY,
        "eligibility_identity": EXPERIMENT4_DERIVED_ELIGIBILITY_IDENTITY,
        "implementation_identity": EXPERIMENT4_DERIVED_IMPLEMENTATION_IDENTITY,
        "semantic_identity": EXPERIMENT4_DERIVED_SEMANTIC_IDENTITY,
    },
)
...
EXPERIMENT4_MEASUREMENT_COMPONENT_SET_IDENTITY = execution_identity(
    _MEASUREMENT_COMPONENT_SET_DOMAIN,
    {
        ...
        "derived_definition_identity": DEPLOYMENT_PER_MINER_DEFINITION_IDENTITY,
        "derived_executable_binding_identity": (
            EXPERIMENT4_DERIVED_EXECUTABLE_BINDING_IDENTITY
        ),
    },
)

EXPERIMENT4_FEATURE_SET_IDENTITY = hashlib.sha256(
    canonical_encode(
        {
            "domain": _FEATURE_SET_DOMAIN,
            "material": {
                "ordered_fields": ("deployment_per_miner",),
...
EXPERIMENT4_PRIMARY_RANKING_IDENTITY = hashlib.sha256(
    canonical_encode(
        {
            "domain": _PRIMARY_RANKING_DOMAIN,
            "material": {
                "direction": "descending",
                "field": "deployment_per_miner",
                "representation": "canonical_reduced_nonnegative_rational",
...
EXPERIMENT4_ASCENDING_RANKING_IDENTITY = hashlib.sha256(
    canonical_encode(
        {
...
EXPERIMENT4_DETERMINISTIC_BASELINE_IDENTITY = hashlib.sha256(
    canonical_encode(
        {
...
EXPERIMENT4_SEEDED_RANDOM_BASELINE_IDENTITY = hashlib.sha256(
    canonical_encode(
        {
...
class Experiment4Configuration:
    """Immutable paths and fixed governing-protocol parameters."""

    replay_dataset_path: Path
    output_directory: Path
    expected_dataset_sha256: str = EXPERIMENT4_DATASET_SHA256
    requested_slots_remaining: int = EXPERIMENT4_REQUESTED_SLOTS_REMAINING
    ...
    def __post_init__(self) -> None:
        ...
        if self.requested_slots_remaining != EXPERIMENT4_REQUESTED_SLOTS_REMAINING:
            raise ValueError("Experiment 4 requires requested_slots_remaining=5")
        if self.max_slot_distance is not None:
            raise ValueError("Experiment 4 does not permit a maximum slot distance")
        ...
        experiment_configuration_identity = execution_identity(
                _EXPERIMENT_CONFIGURATION_DOMAIN,
                {
                    "artifact_names": EXPERIMENT4_ARTIFACT_NAMES,
                    "ascending_ranking_identity": (
                        EXPERIMENT4_ASCENDING_RANKING_IDENTITY
                    ),
                    "bootstrap_confidence": EXPERIMENT4_BOOTSTRAP_CONFIDENCE,
                    "bootstrap_replicates": EXPERIMENT4_BOOTSTRAP_REPLICATES,
                    "candidate_order": tuple(range(25)),
                    ...
                    "deterministic_baseline_identity": (
                        EXPERIMENT4_DETERMINISTIC_BASELINE_IDENTITY
                    ),
                    "feature_set_identity": EXPERIMENT4_FEATURE_SET_IDENTITY,
                    "fold_count": EXPERIMENT4_FOLD_COUNT,
                    "measurement_component_set_identity": (
                        EXPERIMENT4_MEASUREMENT_COMPONENT_SET_IDENTITY
                    ),
                    "primary_ranking_identity": (
                        EXPERIMENT4_PRIMARY_RANKING_IDENTITY
                    ),
                    "protocol_revision": EXPERIMENT4_PROTOCOL_REVISION,
                    "protocol_source_revision": (
                        EXPERIMENT4_PROTOCOL_SOURCE_REVISION
                    ),
                    "seeded_random_baseline_identity": (
                        EXPERIMENT4_SEEDED_RANDOM_BASELINE_IDENTITY
                    ),
                },
            )
        object.__setattr__(
...
def _average_ranks(
    values: Sequence[CanonicalRational], *, descending: bool
) -> tuple[float, ...]:
    if len(values) != 25:
        raise ValueError("ranking requires exactly 25 candidates")
    if any(not isinstance(value, CanonicalRational) for value in values):
        raise TypeError("ranking values must be canonical rationals")
...
def _tie_sizes(values: Sequence[CanonicalRational]) -> tuple[int, ...]:
    keys = tuple((value.numerator, value.denominator) for value in values)
    counts = Counter(keys)
    return tuple(counts[value] for value in keys)
...
def _ranking_record(
    *,
    ...
    deployment_per_miner_values: Sequence[CanonicalRational],
    decision_configuration_identity: str,
) -> dict[str, Any]:
    primary_ranks = _average_ranks(
        deployment_per_miner_values, descending=True
    )
    ascending_ranks = _average_ranks(
        deployment_per_miner_values, descending=False
    )
    random_ranks = _seeded_random_ranks(decision_identity)
    tie_sizes = _tie_sizes(deployment_per_miner_values)
    candidates = tuple(
        {
            "ascending_sensitivity_average_rank": ascending_ranks[square],
            "candidate_square": square,
            "deployment_per_miner": deployment_per_miner_values[square].to_dict(),
    ...
    material: dict[str, Any] = {
        "ascending_ranking_identity": EXPERIMENT4_ASCENDING_RANKING_IDENTITY,
        ...
        "deployment_per_miner_dependency_identity": (
            EXPERIMENT4_DERIVED_DEPENDENCY_IDENTITY
        ),
        "deployment_per_miner_eligibility_identity": (
            EXPERIMENT4_DERIVED_ELIGIBILITY_IDENTITY
        ),
        "deployment_per_miner_executable_binding_identity": (
            EXPERIMENT4_DERIVED_EXECUTABLE_BINDING_IDENTITY
        ),
        "deployment_per_miner_implementation_identity": (
            EXPERIMENT4_DERIVED_IMPLEMENTATION_IDENTITY
        ),
        "deployment_per_miner_semantic_identity": (
            EXPERIMENT4_DERIVED_SEMANTIC_IDENTITY
        ),
        "deployed_lamports_executable_binding_identity": (
            DEPLOYED_LAMPORTS_EXECUTABLE_BINDING_IDENTITY
        ),
        ...
        "primary_ranking_identity": EXPERIMENT4_PRIMARY_RANKING_IDENTITY,
        "round_id": lifecycle.round_id,
        "schema_version": EXPERIMENT4_SCHEMA_VERSION,
        "seeded_random_baseline_identity": (
            EXPERIMENT4_SEEDED_RANDOM_BASELINE_IDENTITY
        ),
...
def _validate_ranking_record(record: Mapping[str, Any]) -> None:
    ...
    if record.get("schema_version") != EXPERIMENT4_SCHEMA_VERSION:
    ...
    for name, expected in (
        ...
        (
            "miner_count_definition_identity",
            MINER_COUNT_DEFINITION.definition_identity,
        ),
        (
            "miner_count_executable_binding_identity",
    ...
    values = tuple(
        CanonicalRational.from_dict(candidate["deployment_per_miner"])
        for candidate in candidates
    )
    primary_ranks = _average_ranks(values, descending=True)
    ascending_ranks = _average_ranks(values, descending=False)
    tie_sizes = _tie_sizes(values)
    for square, candidate in enumerate(candidates):
        if candidate["primary_average_rank"] != primary_ranks[square]:
            raise ValueError("primary rank does not reconstruct exactly")
        if (
            candidate["ascending_sensitivity_average_rank"]
            != ascending_ranks[square]
        ):
            raise ValueError("ascending rank does not reconstruct exactly")
        if candidate["primary_tie_group_size"] != tie_sizes[square]:
            raise ValueError("primary tie size does not reconstruct exactly")
...
def _build_rankings(
    configuration: Experiment4Configuration,
    ...
    miner_count_index = RQ003_EXPERIMENT0_OUTPUT_NAMES.index("miner_count")
    ...
    for lifecycle in lifecycles:
        ...
        derived_conformance_failure = False
        ...
        for square in range(25):
            ...
            deployed = vector.ordered_values[deployed_index]
            miners = vector.ordered_values[miner_count_index]
            if (
                isinstance(deployed, bool)
                or not isinstance(deployed, int)
                or deployed < 0
            ):
                raise ValueError("deployed_lamports output is invalid")
            if isinstance(miners, bool) or not isinstance(miners, int) or miners < 0:
                raise ValueError("miner_count output is invalid")
            vectors.append(vector)
            try:
                ratio, _empty_extension = deployment_per_miner(deployed, miners)
            except ValueError as error:
                if str(error) != "positive deployment with zero miners is invalid":
                    raise
                derived_conformance_failure = True
                break
            if CanonicalRational.from_dict(ratio.to_dict()) != ratio:
                raise ValueError("Deployment per Miner does not reconstruct")
            ratios.append(ratio)
        if derived_conformance_failure:
            selection_audit.append(
                {
                    "round_id": lifecycle.round_id,
                    "status": "undefined_deployment_per_miner",
                }
            )
            continue
        if decision_identity is None:
        ...
        records.append(
            _ranking_record(
                ...
                decision_identity=decision_identity,
                vectors=vectors,
                deployment_per_miner_values=ratios,
                decision_configuration_identity=(
                    configuration.decision_configuration_identity
                ),
            )
...
def _join_outcomes(
    ...
    if not isinstance(authorization, ProfiledOutcomeJoinAuthorization) or (
...
def _load_report(path: Path, expected_kind: str) -> dict[str, Any]:
    ...
    if report.get("experiment_protocol_revision") != EXPERIMENT4_PROTOCOL_REVISION:
...
def validate_experiment4_artifacts(
    ...
    *,
    ...
    if actual_names != tuple(sorted(EXPERIMENT4_ARTIFACT_NAMES)):
    ...
    reports = {
        ...
        CONFORMANCE_ARTIFACT_NAME: _load_report(
            output / CONFORMANCE_ARTIFACT_NAME, "conformance"
        ),
    }
    ...
    manifest_material = validate_profiled_audit_manifest(
        output / AUDIT_MANIFEST_NAME,
        expected=expected_manifest,
    )
    if (
        manifest_material["execution_profile"]["execution_profile"]
        != OUTCOME_AWARE_PROFILE
    ):
        raise ValueError("Experiment 4 manifest has the wrong execution profile")
    experiment_material = manifest_material["outcome_blind_provenance"][
        "experiment"
    ]
    if experiment_material["protocol_revision"] != EXPERIMENT4_PROTOCOL_REVISION:
        raise ValueError("Experiment 4 protocol revision is inconsistent")
    if (
        experiment_material["protocol_document_sha256"]
        != EXPERIMENT4_PROTOCOL_DOCUMENT_SHA256
    ):
        raise ValueError("Experiment 4 protocol identity is inconsistent")
    ...
    evaluation_dispositions = manifest_material["terminal"][
    ...
    return tuple(
        ...
        for name in EXPERIMENT4_ARTIFACT_NAMES
    )
...
def _report(kind: str, material: Mapping[str, Any]) -> dict[str, Any]:
    report: dict[str, Any] = {
        "experiment": "rq003-experiment-004-deployment-per-miner-predictive-evaluation",
        "experiment_protocol_revision": EXPERIMENT4_PROTOCOL_REVISION,
        "kind": kind,
        "protocol_source_revision": EXPERIMENT4_PROTOCOL_SOURCE_REVISION,
        "schema_version": EXPERIMENT4_SCHEMA_VERSION,
        **material,
...
def _bootstrap(records: Sequence[Mapping[str, Any]]) -> dict[str, Any]:
    ...
    for replicate in range(EXPERIMENT4_BOOTSTRAP_REPLICATES):
        det_sum = 0.0
        random_sum = 0.0
        remaining = count
    ...
    tail = (1.0 - EXPERIMENT4_BOOTSTRAP_CONFIDENCE) / 2.0
    comparisons = {}
    for name, observed, samples in (
        ...
        comparisons[name] = {
            "adjusted_confidence_level": EXPERIMENT4_BOOTSTRAP_CONFIDENCE,
    ...
    return _report(
        "bootstrap",
        {
            ...
            "replicates": EXPERIMENT4_BOOTSTRAP_REPLICATES,
...
def _fold_report(primary: Sequence[Mapping[str, Any]]) -> dict[str, Any]:
    ...
    count = len(primary)
    base, remainder = divmod(count, EXPERIMENT4_FOLD_COUNT)
    offset = 0
    for index in range(EXPERIMENT4_FOLD_COUNT):
    ...
    return _report(
        "chronological_folds",
        {
            "adequate_support_threshold": EXPERIMENT4_ADEQUATE_SUPPORT,
            "fold_count": EXPERIMENT4_FOLD_COUNT,
            "folds": folds,
...
def _metrics_report(
    ...
    for ranking in ranking_records:
        ...
        groups = Counter((value.numerator, value.denominator) for value in values)
...
def _experiment_binding(
    ...
    return ExperimentProtocolV2Binding(
        experiment_identifier=(
            "rq003_experiment_004"
        ),
        protocol_revision=EXPERIMENT4_PROTOCOL_REVISION,
        protocol_document_sha256=EXPERIMENT4_PROTOCOL_DOCUMENT_SHA256,
        specification=EXPERIMENT4_SPECIFICATION_BINDING,
        profile=EXPERIMENT4_PROFILE_BINDING,
...
def _dataset_binding(path: Path, sha256: str) -> ReplayDatasetBinding:
    return ReplayDatasetBinding(
        ...
        schema_identity=EXPERIMENT4_DATASET_SCHEMA_IDENTITY,
...
def _experiment_artifact_declarations() -> dict[str, ArtifactDeclaration]:
    ...
    for name in report_names:
        declarations[name] = _artifact_declaration(
            (
                "conformance"
                if name == CONFORMANCE_ARTIFACT_NAME
...
def _component_identities() -> tuple[tuple[str, str], ...]:
    identities = [
                ("ascending_ranking", EXPERIMENT4_ASCENDING_RANKING_IDENTITY),
                (
                    "deterministic_baseline",
                    EXPERIMENT4_DETERMINISTIC_BASELINE_IDENTITY,
                ),
                ("feature_set", EXPERIMENT4_FEATURE_SET_IDENTITY),
                ("primary_ranking", EXPERIMENT4_PRIMARY_RANKING_IDENTITY),
                (
                    "seeded_random_baseline",
                    EXPERIMENT4_SEEDED_RANDOM_BASELINE_IDENTITY,
                ),
                ...
                (
                    "deployment_per_miner_definition",
                    DEPLOYMENT_PER_MINER_DEFINITION_IDENTITY,
                ),
                (
                    "deployment_per_miner_semantic",
                    EXPERIMENT4_DERIVED_SEMANTIC_IDENTITY,
                ),
                (
                    "deployment_per_miner_implementation",
                    EXPERIMENT4_DERIVED_IMPLEMENTATION_IDENTITY,
                ),
                (
                    "deployment_per_miner_dependency",
                    EXPERIMENT4_DERIVED_DEPENDENCY_IDENTITY,
                ),
                (
                    "deployment_per_miner_eligibility",
                    EXPERIMENT4_DERIVED_ELIGIBILITY_IDENTITY,
                ),
                (
                    "deployment_per_miner_executable_binding",
                    EXPERIMENT4_DERIVED_EXECUTABLE_BINDING_IDENTITY,
                ),
    ]
    identities.extend(
...
def execute_experiment4(configuration: Experiment4Configuration) -> Experiment4Result:
    """Execute Experiment 4 through the shared RQ-003 execution lifecycle."""

    if not isinstance(configuration, Experiment4Configuration):
        raise TypeError("configuration must be Experiment4Configuration")
    ...
    replay = ProfiledReplayIdentity(
        specification_identity=(
            EXPERIMENT4_SPECIFICATION_BINDING.specification_identity
        ),
        profile_identity=EXPERIMENT4_PROFILE_BINDING.profile_identity,
        experiment_binding_identity=experiment.experiment_binding_identity,
        experiment_configuration_identity=(
            configuration.profiled_configuration.experiment_configuration_identity
        ),
        ...
        protocol_revision_identity=(
            EXPERIMENT4_PROTOCOL_REVISION_POPULATION_IDENTITY
        ),
        ...
        downstream_artifact_declarations=tuple(
            sorted(
                (
                    name,
                    ProfiledArtifactDeclaration(
                        EXPERIMENT4_PROFILE_BINDING.profile_identity,
                        declaration,
                    ),
                )
    ...
    ranking_contract = construct_profile_artifact_contract(
        ranking_path,
    ...
    authorization = authorize_profiled_outcome_join(block, ranking_contract)
    ...
    outcome_source_records = open_profiled_outcome_source(
        configuration.replay_dataset_path,
        authorization,
    )
    outcome_source_contract = construct_profile_artifact_contract(
        configuration.replay_dataset_path,
    ...
    evaluation_contract = construct_profile_artifact_contract(
        evaluation_path,
    ...
    reports = {
        ...
        CONFORMANCE_ARTIFACT_NAME: _report(
            "conformance",
            {
                "canonical_reconstruction": "validated",
                "decision_context_boundary": "unchanged",
                "deterministic_regeneration": "validated",
                "execution_profile": OUTCOME_AWARE_PROFILE,
                "feature_set_identity": EXPERIMENT4_FEATURE_SET_IDENTITY,
                "feature_set_ordered_fields": ("deployment_per_miner",),
                "measurement_definition_identity": (
                    DEPLOYMENT_PER_MINER_DEFINITION_IDENTITY
                ),
                "measurement_executable_binding_identity": (
                    EXPERIMENT4_DERIVED_EXECUTABLE_BINDING_IDENTITY
                ),
                "outcome_blind_ranking_freeze": "validated",
                "outcome_join_authorization": "validated_after_ranking_freeze",
    ...
    terminal = OutcomeAwareTerminal(
        outcome_join_authorization=authorization,
    ...
    manifest_sha256, _manifest_byte_count = seal_profiled_audit_manifest(
        output / AUDIT_MANIFEST_NAME, manifest
    )

    artifacts = validate_experiment4_artifacts(
        output,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    result = execute_experiment4(
        Experiment4Configuration(
...
__all__ = (
    ...
    "Experiment4Result",
    "execute_experiment4",
    "validate_experiment4_artifacts",
)
