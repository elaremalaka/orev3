"""RQ-003 Experiment 3: direct Miner Count ordering.
...
EXPERIMENT3_SCHEMA_VERSION = 1
EXPERIMENT3_PROTOCOL_REVISION = "1"
EXPERIMENT3_PROTOCOL_DOCUMENT_SHA256 = (
    "e6c8261b312f889b102737a66a06171c872504f44a4e5c02505ddf10141b7069"
)
EXPERIMENT3_PROTOCOL_SOURCE_REVISION = (
    "3112ab78a64f92892a70d5d4cbd17e1d14b1c2fe"
)
EXPERIMENT3_DATASET_SHA256 = (
    "7680856bc6a01f9b69be0921d6e66b3f43d5241a38e63b37871b6925c1d59ba7"
)
EXPERIMENT3_REQUESTED_SLOTS_REMAINING = 5
EXPERIMENT3_FOLD_COUNT = 5
EXPERIMENT3_ADEQUATE_SUPPORT = 100
EXPERIMENT3_BOOTSTRAP_REPLICATES = 10_000
EXPERIMENT3_BOOTSTRAP_CONFIDENCE = 0.975
...
_FEATURE_SET_DOMAIN = "rq003-experiment-003-feature-set-v1"
_PRIMARY_RANKING_DOMAIN = "rq003-experiment-003-primary-ranking-v1"
_ASCENDING_RANKING_DOMAIN = "rq003-experiment-003-ascending-sensitivity-v1"
_DETERMINISTIC_BASELINE_DOMAIN = (
    "rq003-experiment-003-deterministic-baseline-v1"
)
_SEEDED_RANDOM_DOMAIN = "rq003-experiment-003-seeded-random-v1"
_RANKING_RECORD_DOMAIN = "rq003-experiment-003-ranking-record-v1"
_EVALUATION_RECORD_DOMAIN = "rq003-experiment-003-evaluation-record-v1"
_REPORT_DOMAIN = "rq003-experiment-003-report-v1"
_BOOTSTRAP_DOMAIN = "rq003-experiment-003-moving-block-bootstrap-v1"
_EXPERIMENT_CONFIGURATION_DOMAIN = "rq003-experiment-003-configuration-v3"
_REPLAY_DATASET_SCHEMA_DOMAIN = "rq003-replay-dataset-schema-v1"
_REPLAY_ROUND_DOMAIN = "rq003-experiment-003-replay-round-v1"
_PROTOCOL_REVISION_POPULATION_DOMAIN = (
    "rq003-experiment-003-protocol-revision-population-v1"
)
_OUTCOME_SOURCE_DOMAIN = "rq003-experiment-003-outcome-source-v1"
_MEASUREMENT_COMPONENT_SET_DOMAIN = (
    "rq003-experiment-003-measurement-component-set-v1"
)
...
EXPERIMENT3_SPECIFICATION_BINDING = ExecutionSpecificationV2Binding(
    EXECUTION_SPECIFICATION_V2_REVISION,
    EXECUTION_SPECIFICATION_V2_SHA256,
)
EXPERIMENT3_PROFILE_BINDING = ExecutionProfileBinding(
    OUTCOME_AWARE_PROFILE,
)

EXPERIMENT3_DATASET_SCHEMA_IDENTITY = execution_identity(
...
EXPERIMENT3_PROTOCOL_REVISION_POPULATION_IDENTITY = execution_identity(
    _PROTOCOL_REVISION_POPULATION_DOMAIN,
    {
        "dataset_sha256": EXPERIMENT3_DATASET_SHA256,
        "official_source_revision": EXPERIMENT3_PROTOCOL_SOURCE_REVISION,
...
EXPERIMENT3_MEASUREMENT_COMPONENT_SET_IDENTITY = execution_identity(
    _MEASUREMENT_COMPONENT_SET_DOMAIN,
    {
...
EXPERIMENT3_FEATURE_SET_IDENTITY = hashlib.sha256(
    canonical_encode(
        {
            "domain": _FEATURE_SET_DOMAIN,
            "material": {
                "ordered_fields": ("miner_count",),
...
EXPERIMENT3_PRIMARY_RANKING_IDENTITY = hashlib.sha256(
    canonical_encode(
        {
...
EXPERIMENT3_ASCENDING_RANKING_IDENTITY = hashlib.sha256(
    canonical_encode(
        {
...
EXPERIMENT3_DETERMINISTIC_BASELINE_IDENTITY = hashlib.sha256(
    canonical_encode(
        {
...
EXPERIMENT3_SEEDED_RANDOM_BASELINE_IDENTITY = hashlib.sha256(
    canonical_encode(
        {
...
class Experiment3Configuration:
    """Immutable paths and fixed governing-protocol parameters."""

    replay_dataset_path: Path
    output_directory: Path
    expected_dataset_sha256: str = EXPERIMENT3_DATASET_SHA256
    requested_slots_remaining: int = EXPERIMENT3_REQUESTED_SLOTS_REMAINING
    ...
    def __post_init__(self) -> None:
        ...
        if self.requested_slots_remaining != EXPERIMENT3_REQUESTED_SLOTS_REMAINING:
            raise ValueError("Experiment 3 requires requested_slots_remaining=5")
        if self.max_slot_distance is not None:
            raise ValueError("Experiment 3 does not permit a maximum slot distance")
        ...
        experiment_configuration_identity = execution_identity(
                ...
                {
                    "artifact_names": EXPERIMENT3_ARTIFACT_NAMES,
                    "ascending_ranking_identity": (
                        EXPERIMENT3_ASCENDING_RANKING_IDENTITY
                    ),
                    "bootstrap_confidence": EXPERIMENT3_BOOTSTRAP_CONFIDENCE,
                    "bootstrap_replicates": EXPERIMENT3_BOOTSTRAP_REPLICATES,
                    "candidate_order": tuple(range(25)),
                    ...
                    "deterministic_baseline_identity": (
                        EXPERIMENT3_DETERMINISTIC_BASELINE_IDENTITY
                    ),
                    "feature_set_identity": EXPERIMENT3_FEATURE_SET_IDENTITY,
                    "fold_count": EXPERIMENT3_FOLD_COUNT,
                    "measurement_component_set_identity": (
                        EXPERIMENT3_MEASUREMENT_COMPONENT_SET_IDENTITY
                    ),
                    "primary_ranking_identity": (
                        EXPERIMENT3_PRIMARY_RANKING_IDENTITY
                    ),
                    "protocol_revision": EXPERIMENT3_PROTOCOL_REVISION,
                    "protocol_source_revision": (
                        EXPERIMENT3_PROTOCOL_SOURCE_REVISION
                    ),
                    "seeded_random_baseline_identity": (
                        EXPERIMENT3_SEEDED_RANDOM_BASELINE_IDENTITY
                    ),
                },
            )
        object.__setattr__(
...
def _ranking_record(
    *,
    ...
    miner_count: Sequence[int],
    decision_configuration_identity: str,
) -> dict[str, Any]:
    primary_ranks = _average_ranks(miner_count, descending=True)
    ascending_ranks = _average_ranks(miner_count, descending=False)
    random_ranks = _seeded_random_ranks(decision_identity)
    tie_sizes = _tie_sizes(miner_count)
    candidates = tuple(
        {
            "ascending_sensitivity_average_rank": ascending_ranks[square],
            "candidate_square": square,
            "miner_count": miner_count[square],
    ...
    material: dict[str, Any] = {
        "ascending_ranking_identity": EXPERIMENT3_ASCENDING_RANKING_IDENTITY,
        ...
        "primary_ranking_identity": EXPERIMENT3_PRIMARY_RANKING_IDENTITY,
        "round_id": lifecycle.round_id,
        "schema_version": EXPERIMENT3_SCHEMA_VERSION,
        "seeded_random_baseline_identity": (
            EXPERIMENT3_SEEDED_RANDOM_BASELINE_IDENTITY
        ),
...
def _validate_ranking_record(record: Mapping[str, Any]) -> None:
    ...
    if record.get("schema_version") != EXPERIMENT3_SCHEMA_VERSION:
...
def _build_rankings(
    ...
    for lifecycle in lifecycles:
        ...
        for square in range(25):
            ...
            value = vector.ordered_values[miner_count_index]
...
def _load_report(path: Path, expected_kind: str) -> dict[str, Any]:
    ...
    if report.get("experiment_protocol_revision") != EXPERIMENT3_PROTOCOL_REVISION:
...
def validate_experiment3_artifacts(
    ...
    *,
    ...
    if actual_names != tuple(sorted(EXPERIMENT3_ARTIFACT_NAMES)):
    ...
    if (
        ...
        raise ValueError("Experiment 3 manifest has the wrong execution profile")
    experiment_material = manifest_material["outcome_blind_provenance"][
        "experiment"
    ]
    if experiment_material["protocol_revision"] != EXPERIMENT3_PROTOCOL_REVISION:
        raise ValueError("Experiment 3 protocol revision is inconsistent")
    if (
        experiment_material["protocol_document_sha256"]
        != EXPERIMENT3_PROTOCOL_DOCUMENT_SHA256
    ):
        raise ValueError("Experiment 3 protocol identity is inconsistent")
...
def _report(kind: str, material: Mapping[str, Any]) -> dict[str, Any]:
    report: dict[str, Any] = {
        "experiment": "rq003-experiment-003-miner-count-predictive-evaluation",
        "experiment_protocol_revision": EXPERIMENT3_PROTOCOL_REVISION,
        "kind": kind,
        "protocol_source_revision": EXPERIMENT3_PROTOCOL_SOURCE_REVISION,
        "schema_version": EXPERIMENT3_SCHEMA_VERSION,
        **material,
    }
...
def _bootstrap(records: Sequence[Mapping[str, Any]]) -> dict[str, Any]:
    ...
    for replicate in range(EXPERIMENT3_BOOTSTRAP_REPLICATES):
        det_sum = 0.0
        random_sum = 0.0
        remaining = count
    ...
    tail = (1.0 - EXPERIMENT3_BOOTSTRAP_CONFIDENCE) / 2.0
    comparisons = {}
    for name, observed, samples in (
        ...
        comparisons[name] = {
            "adjusted_confidence_level": EXPERIMENT3_BOOTSTRAP_CONFIDENCE,
    ...
    return _report(
        "bootstrap",
        {
            ...
            "replicates": EXPERIMENT3_BOOTSTRAP_REPLICATES,
...
def _fold_report(primary: Sequence[Mapping[str, Any]]) -> dict[str, Any]:
    ...
    count = len(primary)
    base, remainder = divmod(count, EXPERIMENT3_FOLD_COUNT)
    offset = 0
    for index in range(EXPERIMENT3_FOLD_COUNT):
    ...
    return _report(
        "chronological_folds",
        {
            "adequate_support_threshold": EXPERIMENT3_ADEQUATE_SUPPORT,
            "fold_count": EXPERIMENT3_FOLD_COUNT,
            "folds": folds,
...
def _metrics_report(
    ...
    tied_decisions = 0
    for ranking in ranking_records:
        values = [candidate["miner_count"] for candidate in ranking["candidates"]]
...
def _experiment_binding(
    ...
    return ExperimentProtocolV2Binding(
        experiment_identifier=(
            "rq003_experiment_003"
        ),
        protocol_revision=EXPERIMENT3_PROTOCOL_REVISION,
        protocol_document_sha256=EXPERIMENT3_PROTOCOL_DOCUMENT_SHA256,
        specification=EXPERIMENT3_SPECIFICATION_BINDING,
        profile=EXPERIMENT3_PROFILE_BINDING,
...
def _dataset_binding(path: Path, sha256: str) -> ReplayDatasetBinding:
    return ReplayDatasetBinding(
        ...
        schema_identity=EXPERIMENT3_DATASET_SCHEMA_IDENTITY,
...
def _component_identities() -> tuple[tuple[str, str], ...]:
    identities = [
                ("ascending_ranking", EXPERIMENT3_ASCENDING_RANKING_IDENTITY),
                (
                    "deterministic_baseline",
                    EXPERIMENT3_DETERMINISTIC_BASELINE_IDENTITY,
                ),
                ("feature_set", EXPERIMENT3_FEATURE_SET_IDENTITY),
                ("primary_ranking", EXPERIMENT3_PRIMARY_RANKING_IDENTITY),
                (
                    "seeded_random_baseline",
                    EXPERIMENT3_SEEDED_RANDOM_BASELINE_IDENTITY,
                ),
...
def execute_experiment3(configuration: Experiment3Configuration) -> Experiment3Result:
    """Execute Experiment 3 through the shared RQ-003 execution lifecycle."""

    if not isinstance(configuration, Experiment3Configuration):
        raise TypeError("configuration must be Experiment3Configuration")
    ...
    replay = ProfiledReplayIdentity(
        specification_identity=(
            EXPERIMENT3_SPECIFICATION_BINDING.specification_identity
        ),
        profile_identity=EXPERIMENT3_PROFILE_BINDING.profile_identity,
        ...
        protocol_revision_identity=(
            EXPERIMENT3_PROTOCOL_REVISION_POPULATION_IDENTITY
        ),
        ...
        downstream_artifact_declarations=tuple(
            sorted(
                (
                    name,
                    ProfiledArtifactDeclaration(
                        EXPERIMENT3_PROFILE_BINDING.profile_identity,
                        declaration,
                    ),
                )
    ...
    reports = {
        ...
        CONFORMANCE_ARTIFACT_NAME: _report(
            "conformance",
            {
                ...
                "feature_set_identity": EXPERIMENT3_FEATURE_SET_IDENTITY,
                "feature_set_ordered_fields": ("miner_count",),
    ...
    artifacts = validate_experiment3_artifacts(
        output,
